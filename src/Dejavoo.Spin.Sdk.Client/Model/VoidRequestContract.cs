...
namespace Dejavoo.Spin.Sdk.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class VoidRequestContract : IEquatable<VoidRequestContract>
    {
        /// <summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="VoidRequestContract" /> class.
        /// </summary>
        ...
        public VoidRequestContract(double? amount = default, PaymentTypeEnum paymentType = default,
            string referenceId = default, PrintReceiptEnum? printReceipt = default,
            GetReceiptEnum? getReceipt = default, int? merchantNumber = default, bool? captureSignature = default,
            string tpn = default, string authkey = default, int? sPInProxyTimeout = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
                throw new InvalidDataException("amount is a required property for VoidRequestContract and cannot be null");
            Amount = amount;

            // to ensure "paymentType" is required (not null)
            if (paymentType == null)
                throw new InvalidDataException("paymentType is a required property for VoidRequestContract and cannot be null");
            PaymentType = paymentType;

            // to ensure "referenceId" is required (not null)
            if (referenceId == null)
                throw new InvalidDataException("referenceId is a required property for VoidRequestContract and cannot be null");
            ReferenceId = referenceId;

            // to ensure "tpn" is required (not null)
            if (tpn == null)
                throw new InvalidDataException("tpn is a required property for VoidRequestContract and cannot be null");
            Tpn = tpn;
        ...
        /// <summary>
        ///     Returns true if VoidRequestContract instances are equal
        /// </summary>
        /// <param name="input">Instance of VoidRequestContract to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoidRequestContract input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VoidRequestContract {\n");
        ...
        {
            return Equals(input as VoidRequestContract);
        }
