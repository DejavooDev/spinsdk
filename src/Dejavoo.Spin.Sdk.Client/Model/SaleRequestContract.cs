...
namespace Dejavoo.Spin.Sdk.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class SaleRequestContract : IEquatable<SaleRequestContract>
    {
        /// <summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="SaleRequestContract" /> class.
        /// </summary>
        ...
        public SaleRequestContract(double? amount = default, double? tipAmount = default, PaymentTypeEnum paymentType = default,
            string referenceId = default, PrintReceiptEnum? printReceipt = default, GetReceiptEnum? getReceipt = default,
            int? merchantNumber = default, string invoiceNumber = default, bool? captureSignature = default, string tpn = default,
            string authkey = default, int? sPInProxyTimeout = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
                throw new InvalidDataException("amount is a required property for SaleRequestContract and cannot be null");
            Amount = amount;
            // to ensure "paymentType" is required (not null)
            if (paymentType == null)
                throw new InvalidDataException("paymentType is a required property for SaleRequestContract and cannot be null");
            PaymentType = paymentType;
            // to ensure "referenceId" is required (not null)
            if (referenceId == null)
                throw new InvalidDataException("referenceId is a required property for SaleRequestContract and cannot be null");
            ReferenceId = referenceId;
            // to ensure "tpn" is required (not null)
            if (tpn == null)
                throw new InvalidDataException("tpn is a required property for SaleRequestContract and cannot be null");
            Tpn = tpn;
            TipAmount = tipAmount;
        ...
        /// <summary>
        ///     Returns true if SaleRequestContract instances are equal
        /// </summary>
        /// <param name="input">Instance of SaleRequestContract to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SaleRequestContract input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SaleRequestContract {\n");
        ...
        {
            return Equals(input as SaleRequestContract);
        }
